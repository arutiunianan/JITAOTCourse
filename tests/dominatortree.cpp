...
TEST(DominatorTree, TEST_1)
{
    ...
    //auto &aImmDom = tree.immediateDominatedBlocks_[a];     // a->GetImmediateDominatedBlocks();
    //ASSERT_EQ(aImmDom.size(), 1);
    //ASSERT_EQ(aImmDom[0], b);

    auto &bImmDom = tree.immediateDominatedBlocks_[b];   //->GetImmediateDominatedBlocks();
    ...
    auto &cImmDom = tree.immediateDominatedBlocks_[c];      // c->GetImmediateDominatedBlocks();
    ASSERT_EQ(cImmDom.size(), 0);

    auto &dImmDom = tree.immediateDominatedBlocks_[d];     // d->GetImmediateDominatedBlocks();
    ASSERT_EQ(dImmDom.size(), 0);

    auto &fImmDom = tree.immediateDominatedBlocks_[f];     // f->GetImmediateDominatedBlocks();
